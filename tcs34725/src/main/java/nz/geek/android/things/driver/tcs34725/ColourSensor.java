...
public class ColourSensor {
  ...
  public void registerListener(Tcs34725.Listener listener) {
  ...
  public static final class ColourSensorBuilder {
    ...
    private Gpio interruptGpio;
    private String interruptGpioName;
    private Tcs34725.Listener listener = null;
     ...
     * @return the builder
     */
    public ColourSensorBuilder withListener(Tcs34725.Listener listener) {
