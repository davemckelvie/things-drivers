...
public class GpioLcdCharacterDisplay extends AbstractLcdCharacterDisplay {
  ...
  private GpioLcdCharacterDisplay(int width, int height, Gpio e1Pin, Gpio e2Pin, Gpio rsPin, Gpio rwPin,
  ...
  public static GpioLcdCharacterDisplay.Builder builder(int width, int height) {
  ...
  public static final class Builder{
    ...
    public GpioLcdCharacterDisplay build() {
      return new GpioLcdCharacterDisplay(width, height, e1Pin, e2Pin, rsPin, rwPin, blPin,
